            ...
            <div class="collapse navbar-collapse" id="ftco-nav">
                <ul class="navbar-nav ml-auto">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item active"><a href="f_destinasi.rm" class="nav-link">Destinasi</a></li>
    ...
    <div class="container">
        <div class="row no-gutters slider-text align-items-end justify-content-center" style="height:450px;">
            <div class="col-md-9 ftco-animate pb-5 text-center">
                <h2 class="mb-3 bread">Destinasi Wisata Kubu Raya</h2>
        ...
        <div class="container">
            <div class="row justify-content-center pb-4">
                <div class="col-md-12 heading-section text-center ftco-animate">
                    ...
                    <div class="w-40 text-blue-400 mb-4">	
                                        ...
                                        <div class="form-field">
                                            <div class="select-wrap">
                                                ...
                                                <select name="keyword" id="" class="form-control">
                                                    <?php foreach($f_kategori as $kategori ) : ?> 
                                                        <option id="kategori" name="keyword" value="<?= $kategori['nama_kategori'] ?>"> <?= $kategori['nama_kategori']?> </option>
                                                    <?php endforeach; ?>
                                                </select>
                                            </div>
                                        </div>
                            ...
                            <div class="testimony-wrap py-4">
                                <div class="text">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <input type="text" class="form-control" placeholder="Enter Your Email Address" aria-label="Email Address" aria-describedby="button-addon2">
