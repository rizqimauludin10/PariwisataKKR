...
<section class="hero-wrap hero-wrap-2" style="background-image: url('../assets/assets_fe/images/bg_2.jpg'); height:300px;" data-stellar-background-ratio="0.5">
    <div class="overlay" style="height:300px;"></div>
    <div class="container">
        <div class="row no-gutters slider-text align-items-end justify-content-center" style="height:300px;">
            <div class="col-md-9 ftco-animate pb-5 text-center">
                <h3 class="mb-1 bread">Peta Wisata Kubu Raya</h3>

                <div class="w-41 text-blue-403 mb-2">	
